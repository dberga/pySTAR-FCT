...
See [Eye Movements](https://jtl.lassonde.yorku.ca/eye-movements/) and [Selective Tuning](https://jtl.lassonde.yorku.ca/selective-tuning/) posts in [Laboratory of Active and Attentive Vision (LAAV)](https://jtl.lassonde.yorku.ca/) from the Lassonde School of Engineering, [York University](https://www.yorku.ca/).

Preliminary tests were presesented in the Annual Meeting of the Vision Sciences Society 2019 by [Berga et al.](https://www.sciencedirect.com/science/article/abs/pii/S0925231220311553) (VSS 2019) and the prelimiary STAR-FC by [Wloka et al.](https://doi.org/10.1109/cvpr.2018.00336) in the Computer Vision and Pattern Recognition CVPR' 2018. This work is an extension of [Yuulia Kotseruba's](https://github.com/ykotseruba) [pySTAR-FC](https://github.com/ykotseruba/pySTAR-FC). *in any case of use, must cite these two articles*:
